...
options.register('pedestalsHighGain',
                 'CondObjects/data2017/pedestalHG_125.txt',
                 VarParsing.VarParsing.multiplicity.singleton,
                 VarParsing.VarParsing.varType.string,
                 'Path to high gain pedestals file')

options.register('pedestalsLowGain',
                 'CondObjects/data2017/pedestalLG_125.txt',
                 VarParsing.VarParsing.multiplicity.singleton,
                 VarParsing.VarParsing.varType.string,
...
process.rawdataplotter = cms.EDAnalyzer("RawDataPlotter",
                                        ...
                                        HighGainPedestalFileName=cms.untracked.string(options.pedestalsHighGain),
                                        LowGainPedestalFileName=cms.untracked.string(options.pedestalsLowGain)
                                        )
...
process.rawhitproducer = cms.EDProducer("HGCalTBRawHitProducer",
                                        ...
                                        HighGainPedestalFileName=cms.string(options.pedestalsHighGain),
                                        LowGainPedestalFileName=cms.string(options.pedestalsLowGain)
                                        )
...
process.recHitNtuplizer = cms.EDAnalyzer("RecHitsNtuplizer",
                                         ...
                                         ElectronicMap=cms.untracked.string("HGCal/CondObjects/data/map_CERN_Hexaboard_OneLayers_May2017.txt"),
                                         CommonModeThreshold=cms.untracked.double(100),
                                         LG2HG = cms.untracked.vdouble(7.0),
                                         TOT2LG = cms.untracked.vdouble(7.0),
